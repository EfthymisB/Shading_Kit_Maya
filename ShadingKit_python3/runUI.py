        ...
        for txt in sorted(self.ui.buttonGroup.buttons(), key=lambda x: x.text()):
            if txt.isChecked():
                ...
                if txt.text() == 'Displace':
                    ...
                    bump_node = cmds.shadingNode('aiBump2d', asUtility=True, ss=True,
                                                 name="aiBump2d_{}".format(new_shader))
                    ...
                    normal_node = cmds.shadingNode('aiNormalMap', asUtility=True, ss=True,
                                                   name="aiNormalMap_{}".format(new_shader))
