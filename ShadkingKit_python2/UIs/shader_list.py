...
class Ui_shader_list_win(object):
    def setupUi(self, shader_list_win):
        if not shader_list_win.objectName():
            shader_list_win.setObjectName("shader_list_win")
...
"")
    ...
    def retranslateUi(self, shader_list_win):
        shader_list_win.setWindowTitle(QCoreApplication.translate("shader_list_win", "MainWindow", None))
        self.ok_but.setText(QCoreApplication.translate("shader_list_win", "Delete", None))
        self.cancel_but.setText(QCoreApplication.translate("shader_list_win", "Cancel", None))
    # retranslateUi
